var speakWorker;
try {
  speakWorker = new Worker('js/speak/speak.js-master/speakWorker.js');
} catch(e) {
...
function speak(text, args) {
  ...
  function playHTMLAudioElement(wav) {
    ...
    document.getElementById("audioSpeak").innerHTML=("<audio id=\"player\" src=\"data:audio/x-wav;base64,"+encode64(wav)+"\">");
